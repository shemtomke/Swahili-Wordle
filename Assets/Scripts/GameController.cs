...
public class GameController : MonoBehaviour
{
    ...
    //UI to display the Game has ended
    ...
    public void RemoveLetterFromWordBox() //on click backspace
    {
        if (currentRow > amountOfRows)
        {
            Debug.Log("No more rows available");
    ...
    public void SubmitWord() //on click enter key
    {
        // The players guess
        string guess = "";
    ...
    public void Home()//Go back to home page/main menu
    {
        //automatically reset game
        //clear boxes and word
        //each level has a certain word (do not change)

    }
    public void GoBack()//go back to levels menu
    {
        //clear boxes
